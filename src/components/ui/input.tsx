...
const Input = React.memo(
  React.forwardRef<HTMLInputElement, InputProps>(({ className, label, required, icon, error, type, ...props }, ref) => {
...
const TextArea = React.memo(
  React.forwardRef<HTMLTextAreaElement, TextareaProps>(({ className, label, required, error, ...props }, ref) => {
    const containerClassNames = React.useMemo(() => {
      const baseClasses =
