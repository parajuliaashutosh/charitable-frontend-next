...
import { Eye, EyeOff, Heart, Mail, Phone, User } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Join as Donor</h1>
          <p className="text-blue-100">Start making a difference today</p>
        </div>
